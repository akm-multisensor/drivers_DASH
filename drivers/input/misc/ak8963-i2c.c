...
static const struct of_device_id ak8963_of_match[] = {
	{ .compatible = "akm,ak8963", },
	{ },
};
MODULE_DEVICE_TABLE(of, ak8963_of_match);

#ifdef CONFIG_ACPI
static const struct acpi_device_id ak8963_acpi_match[] = {
	{ AKM_DRIVER_NAME, 0 },
	{ },
};
#endif
...
static struct i2c_driver ak8963_i2c_driver = {
	...
	.driver = {
		...
		.owner = THIS_MODULE,
		.pm = &ak8963_i2c_pops,
		.of_match_table = ak8963_of_match,
		.acpi_match_table = ACPI_PTR(ak8963_acpi_match),
	},
};

module_i2c_driver(ak8963_i2c_driver)
